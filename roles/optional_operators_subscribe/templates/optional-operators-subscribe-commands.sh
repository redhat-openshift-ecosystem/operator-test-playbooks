...
# the following script is fetched from https://steps.ci.openshift.org/reference/optional-operators-subscribe.

# if you would like to update the script please sync with 
# changes from https://github.com/openshift/release/blob/master/ci-operator/step-registry/optional-operators/subscribe/optional-operators-subscribe-commands.sh
